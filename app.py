...
if not hasattr(ku, "trouver_xlsform"):
    import streamlit as _st
    _st.error("**`kobo_utils.py` n'est pas à jour.** Déposez la dernière version de "
              "`kobo_utils.py` (ainsi que `form_quanti.xlsx` et `form_quali.xlsx`) "
              "à côté de `app.py`, puis relancez l'application.")
    _st.stop()
